    ...
    if ($(".select1")) {
        $(".select1").change(function() {
            if ($(".select1 option:selected").val() == "Двери") {
                ...
                let wins1 =
                    '<div class="slideshow-container"><div class="mySlides1" onclick="plusSlides(1,0)"><img src="../../images/leaf-x.png"><div class="wincalc-layout-label" label-id="leaf_left" >Глухая створка</div></div><div class="mySlides1" onclick="plusSlides(1,0)"><img src="../../images/leaf-l.png"><div class="wincalc-layout-label" label-id="leaf_left" >Повортная влево</div></div><div class="mySlides1" onclick="plusSlides(1,0)"><img src="../../images/leaf-lu.png"><div class="wincalc-layout-label" label-id="leaf" >Повортно/откидная левая</div></div><div class="mySlides1" onclick="plusSlides(1,0)"><img src="../../images/leaf-r.png"><div class="wincalc-layout-label" label-id="leaf" >Повортная вправо</div></div><div class="mySlides1" onclick="plusSlides(1,0)"><img src="../../images/leaf-ru.png"><div class="wincalc-layout-label" label-id="leaf" >Повортная/откидная правая</div></div><div class="sizer-up" title="Ширина" ><div class="sizer-up-line" style="position: absolute; left: 0px; top: 5px; width: 98px;"></div><div class="sizer-up-arrow1" style="position: absolute; left: 0px; top: 0px;"></div><div class="sizer-up-arrow2" style="position: absolute; left: 84px; top: 0px;"></div><input type="text" name="width" maxlength="4" value="700" style="position: absolute; left: 21px; top: -13.5px;"></div><div class="sizer-right" title="Высота" style="position: absolute; left: 101px; top: 0px; width: 12px; height: 198px;"><div class="sizer-right-line" style="position: absolute; left: 13px; top: 0px; height: 198px;"></div><div class="sizer-right-arrow1" style="position: absolute; left: 7.5px; top: 0px;"></div><div class="sizer-right-arrow2" style="position: absolute; left: 7.5px; top: 186px;"></div><input type="text" name="height" maxlength="4" value="1500" style="position: absolute; left: -10px; top: 85.5px;"></div></div>';
    ...
    if (winsContainer) {
        ...
        for (var i = 0; i < winsLi.length; i++) {
            winsLi[i].addEventListener("click", function() {
                ...
                var wins2 =
                    '<div class="slideshow-container"><div class="mySlides1" onclick="plusSlides(1,0)"><img src="../../images/leaf-x.png"><div class="wincalc-layout-label" label-id="leaf_left" >Глухая створка</div></div><div class="mySlides1" onclick="plusSlides(1,0)"><img src="../../images/leaf-r.png"><div class="wincalc-layout-label" label-id="leaf" >Повортная вправо</div></div><div class="mySlides1" onclick="plusSlides(1,0)"><img src="../../images/leaf-ru.png"><div class="wincalc-layout-label" label-id="leaf" >Повортная/откидная правая</div></div></div>' +
                    '<div class="slideshow-container"><div class="mySlides2" onclick="plusSlides(1,1)"><img src="../../images/leaf-x.png"><div class="wincalc-layout-label" label-id="leaf_left" >Глухая створка</div></div><div class="mySlides2" onclick="plusSlides(1,1)"><img src="../../images/leaf-l.png"><div class="wincalc-layout-label" label-id="leaf_left" >Повортная влево</div></div><div class="mySlides2" onclick="plusSlides(1,1)"><img src="../../images/leaf-lu.png"><div class="wincalc-layout-label" label-id="leaf" >Повортно/откидная левая</div></div><div class="sizer-up" title="Общая ширина окна" style="position: absolute; left: -100px; top: -13px; width: 198px; height: 12px;"><div class="sizer-up-line" style="position: absolute; left: 0px; top: 5px; width: 198px;"></div><div class="sizer-up-arrow1" style="position: absolute; left: 0px; top: 0px;"></div><div class="sizer-up-arrow2" style="position: absolute; left: 184px; top: 0px;"></div><input type="text" name="width" maxlength="4" value="1400" style="position: absolute; left: 71px; top: -13.5px;"></div><div class="sizer-right" title="Высота" style="position: absolute; left: 100px; top: 0px; width: 12px; height: 198px;"><div class="sizer-right-line" style="position: absolute; left: 13px; top: 0px; height: 198px;"></div><div class="sizer-right-arrow1" style="position: absolute; left: 7.5px; top: 0px;"></div><div class="sizer-right-arrow2" style="position: absolute; left: 7.5px; top: 186px;"></div><input type="text" name="height" maxlength="4" value="1500" style="position: absolute; left: -10px; top: 85.5px;"></div><div class="sizer-down" title="Ширина левой створки" style="position: absolute; left: -100px; top: 200px; width: 98px; height: 12px;"><div class="sizer-down-line" style="position: absolute; left: 0px; top: 13px; width: 98px;"></div><div class="sizer-down-arrow1" style="position: absolute; left: 0px; top: 8px;"></div><div class="sizer-down-arrow2" style="position: absolute; left: 84px; top: 8px;"></div><input type="text" name="left_width" maxlength="4" value="700" style="position: absolute; left: 21px; top: 0.5px;"></div></div>';

                var wins3 =
                    '<div class="slideshow-container"><div class="mySlides1" onclick="plusSlides(1,0)"><img src="../../images/leaf-x.png"><div class="wincalc-layout-label" label-id="leaf_left">Глухая створка</div></div><div class="mySlides1" onclick="plusSlides(1,0)"><img src="../../images/leaf-r.png"><div class="wincalc-layout-label" label-id="leaf">Повортная вправо</div> </div><div class="mySlides1" onclick="plusSlides(1,0)"><img src="../../images/leaf-ru.png"><div class="wincalc-layout-label" label-id="leaf">Повортная/откидная правая</div></div></div>' +
                    '<div class="slideshow-container"><div class="mySlides2" onclick="plusSlides(1,1)"><img src="../../images/leaf-x.png"><div class="wincalc-layout-label" label-id="leaf_left" >Глухая створка</div></div><div class="mySlides2" onclick="plusSlides(1,1)"><img src="../../images/leaf-l.png"><div class="wincalc-layout-label" label-id="leaf_left" >Повортная влево</div></div><div class="mySlides2" onclick="plusSlides(1,1)"><img src="../../images/leaf-lu.png"><div class="wincalc-layout-label" label-id="leaf" >Повортно/откидная левая</div></div><div class="mySlides2" onclick="plusSlides(1,1)"><img src="../../images/leaf-r.png"><div class="wincalc-layout-label" label-id="leaf" >Повортная вправо</div></div><div class="mySlides2" onclick="plusSlides(1,1)"><img src="../../images/leaf-ru.png"> <div class="wincalc-layout-label" label-id="leaf" >Повортная/откидная правая</div></div></div>' +
                    '<div class="slideshow-container"><div class="mySlides3" onclick="plusSlides(1,2)"><img src="../../images/leaf-x.png"><div class="wincalc-layout-label" label-id="leaf_left" >Глухая створка</div></div><div class="mySlides3" onclick="plusSlides(1,2)"><img src="../../images/leaf-l.png"><div class="wincalc-layout-label" label-id="leaf_left" >Повортная влево</div></div><div class="mySlides3" onclick="plusSlides(1,2)"><img src="../../images/leaf-lu.png"><div class="wincalc-layout-label" label-id="leaf" >Повортно/откидная левая</div></div></div>' +
                    '<div class="sizer-up sizer-up3" title="Общая ширина"><div class="sizer-up-line" style="position: absolute; left: 0px; top: 5px; width: 298px;"></div><div class="sizer-up-arrow1" style="position: absolute; left: 0px; top: 0px;"></div><div class="sizer-up-arrow2" style="position: absolute; left: 284px; top: 0px;"></div><input type="text" name="width" maxlength="4" value="2100" style="position: absolute; left: 121px; top: -13.5px;"></div>' +
                    '<div class="sizer-right sizer-right3" title="Высота" ><div class="sizer-right-line" style="position: absolute; left: 13px; top: 0px; height: 198px;"></div><div class="sizer-right-arrow1" style="position: absolute; left: 7.5px; top: 0px;"></div><div class="sizer-right-arrow2" style="position: absolute; left: 7.5px; top: 186px;"></div><input type="text" name="height" maxlength="4" value="1500" style="position: absolute; left: -11px; top: 85.5px;"></div>' +
                    '<div class="sizer-down sizer-down31" title="Ширина левой створки"><div class="sizer-down-line" style="position: absolute; left: 0px; top: 13px; width: 98px;"></div><div class="sizer-down-arrow1" style="position: absolute; left: 0px; top: 8px;"></div><div class="sizer-down-arrow2" style="position: absolute; left: 84px; top: 8px;"></div><input type="text" name="left_width" maxlength="4" value="700" style="position: absolute; left: 21px; top: 0.5px;"></div>' +
                    '<div class="sizer-down sizer-down3" title="Ширина правой створки"><div class="sizer-down-line" style="position: absolute; left: 0px; top: 13px; width: 98px;"></div><div class="sizer-down-arrow1" style="position: absolute; left: 0px; top: 8px;"></div><div class="sizer-down-arrow2" style="position: absolute; left: 84px; top: 8px;"></div><input type="text" name="right_width" maxlength="4" value="700" style="position: absolute; left: 21px; top: 0.5px;"></div>';

                var wins4 =
                    '<div class="slideshow-container"><div class="mySlides1" onclick="plusSlides(1,0)"><img src="../../images/leaf-x.png"><div class="wincalc-layout-label" label-id="leaf_left" >Глухая створка</div></div><div class="mySlides1" onclick="plusSlides(1,0)"><img src="../../images/leaf-r.png"><div class="wincalc-layout-label" label-id="leaf" >Повортная вправо</div> </div><div class="mySlides1" onclick="plusSlides(1,0)"><img src="../../images/leaf-ru.png"><div class="wincalc-layout-label" label-id="leaf" >Повортная/откидная правая</div></div></div>' +
                    '<div class="slideshow-container"><div class="mySlides2" onclick="plusSlides(1,1)"><img src="../../images/leaf-x.png"><div class="wincalc-layout-label" label-id="leaf_left" >Глухая створка</div></div><div class="mySlides2" onclick="plusSlides(1,1)"><img src="../../images/leaf-l.png"><div class="wincalc-layout-label" label-id="leaf_left" >Повортная влево</div></div><div class="mySlides2" onclick="plusSlides(1,1)"><img src="../../images/leaf-lu.png"><div class="wincalc-layout-label" label-id="leaf" >Повортно/откидная левая</div></div><div class="mySlides2" onclick="plusSlides(1,1)"><img src="../../images/leaf-r.png"><div class="wincalc-layout-label" label-id="leaf" >Повортная вправо</div> </div><div class="mySlides2" onclick="plusSlides(1,1)"><img src="../../images/leaf-ru.png"><div class="wincalc-layout-label" label-id="leaf" >Повортная/откидная правая</div>  </div></div>' +
                    '<div class="slideshow-container"><div class="mySlides3" onclick="plusSlides(1,2)"><img src="../../images/leaf-x.png"><div class="wincalc-layout-label" label-id="leaf_left" >Глухая створка</div></div><div class="mySlides3" onclick="plusSlides(1,2)"><img src="../../images/leaf-l.png"><div class="wincalc-layout-label" label-id="leaf_left" >Повортная влево</div></div><div class="mySlides3" onclick="plusSlides(1,2)"><img src="../../images/leaf-lu.png"><div class="wincalc-layout-label" label-id="leaf" >Повортно/откидная левая</div></div><div class="mySlides3" onclick="plusSlides(1,2)"><img src="../../images/leaf-r.png"><div class="wincalc-layout-label" label-id="leaf" >Повортная вправо</div> </div><div class="mySlides3" onclick="plusSlides(1,2)"><img src="../../images/leaf-ru.png"><div class="wincalc-layout-label" label-id="leaf" >Повортная/откидная правая</div>  </div></div>' +
                    '<div class="slideshow-container"><div class="mySlides4" onclick="plusSlides(1,3)"><img src="../../images/leaf-x.png"><div class="wincalc-layout-label" label-id="leaf_left" >Глухая створка</div></div><div class="mySlides4" onclick="plusSlides(1,3)"><img src="../../images/leaf-l.png"><div class="wincalc-layout-label" label-id="leaf_left" >Повортная влево</div></div><div class="mySlides4" onclick="plusSlides(1,3)"><img src="../../images/leaf-lu.png"><div class="wincalc-layout-label" label-id="leaf" >Повортно/откидная левая</div></div></div>' +
    ...
    if (doorsContainer) {
        ...
        for (var i = 0; i < doorsLi.length; i++) {
            doorsLi[i].addEventListener("click", function() {
                ...
                var wins11 =
                    '<div class="slideshow-container"><div class="mySlides2" onclick="plusSlides(1,1)"><img src="../../images/leaf-x.png"><div class="wincalc-layout-label" label-id="leaf_left" >Глухая створка</div></div><div class="mySlides2" onclick="plusSlides(1,1)"><img src="../../images/leaf-r.png"><div class="wincalc-layout-label" label-id="leaf" >Повортная вправо</div></div><div class="mySlides2" onclick="plusSlides(1,1)"><img src="../../images/leaf-ru.png"><div class="wincalc-layout-label" label-id="leaf" >Повортная/откидная правая</div> </div></div>';
